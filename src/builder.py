...
class Builder:
    ...
    def build_place(self, plan, gui, IV, solver):
        ...
        self.place.legend = gui.text(
            'Welcome to Kuarup!', x=350, y=45, font_size=20, text_anchor="middle",
    ...
    def build_land(self, gui):
        ...
        gui.image(href=REPO % 'forest.jpg', x=0, y=0, width=900, height=600)
        #image = gui.rect(x=100,y=100, width=600, height=400,style={'fill':'navajowhite'})
        gui.rect(x=100, y=100, width=608, height=416, style={'fill': 'url(#EMFimage1)'})
